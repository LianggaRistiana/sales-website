    ...
    <>
      <div className="space-y-1 mt-4 flex justify-between">
        ...
        <div className="text-right">
          ...
          <Button isIconOnly className="mt-[100px] transition-transform duration-300 transform-gpu bg-[#ffffff] text-red-500 hover:bg-[#ef4444] hover:text-white hover:scale-110">
  ...
  return (
    <div>
      <ButtonGroup size="sm" className="mt-4">
        <Button className="bg-[#000000] text-white transition-transform duration-300 transform-gpu hover:text[64px] hover:font-bold" onClick={decrementCount}>
          -
        </Button>
        <div className="px-1 py-1 text-white bg-[#000000] ">
          <h1>{count}</h1>
        </div>
        <Button className="bg-[#000000] text-white transition-transform duration-300 transform-gpu hover:text[64px] hover:font-bold" onClick={incrementCount}>
          +
        </Button>
      </ButtonGroup>
    </div>
